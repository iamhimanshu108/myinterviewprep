...
export const messageQueuesWorkflow: WorkflowTopicData = {
    id: 'message-queues',
    title: 'Message Queues & Streams',
    subtitle: 'Kafka, RabbitMQ, pub/sub, async processing',
    tagline: 'Deep dive into Message Queues & Streams concepts and code architectures.',
    accentColor: '#6366f1', // Indigo
    category: 'System Design',
    tags: ["Kafka","RabbitMQ","Pub/Sub","Async"],
    sections: [
      { id: 'message-queues-01', num: 1, label: 'Core Principles', group: 'Phase 1: Beginner' }
    ],
    flowSteps: [
      {
    ...
    comparisonPoints: [],
    quiz: {
      question: 'Placeholder Quiz for Message Queues & Streams',
      options: ['A', 'B', 'C', 'D'],
      correctIndex: 0,
