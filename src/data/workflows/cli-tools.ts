...
export const cliToolsWorkflow: WorkflowTopicData = {
    id: 'cli-tools',
    title: 'CLI & Terminal Tools',
    subtitle: 'Bash, SSH, package managers, grep/sed/awk',
    tagline: 'Deep dive into CLI & Terminal Tools concepts and code architectures.',
    accentColor: '#6366f1', // Indigo
    category: 'Fundamentals',
    tags: ["Bash","SSH","grep","awk"],
    sections: [
      { id: 'cli-tools-01', num: 1, label: 'Core Principles', group: 'Phase 1: Beginner' }
    ],
    flowSteps: [
      {
    ...
    comparisonPoints: [],
    quiz: {
      question: 'Placeholder Quiz for CLI & Terminal Tools',
      options: ['A', 'B', 'C', 'D'],
      correctIndex: 0,
