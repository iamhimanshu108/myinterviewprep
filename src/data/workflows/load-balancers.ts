...
export const loadBalancersWorkflow: WorkflowTopicData = {
    id: 'load-balancers',
    title: 'Load Balancers & Reverse Proxies',
    subtitle: 'Nginx, HAProxy, Round-robin, Layer 4 vs Layer 7',
    tagline: 'Deep dive into Load Balancers & Reverse Proxies concepts and code architectures.',
    accentColor: '#6366f1', // Indigo
    category: 'System Design',
    tags: ["Nginx","Layer 4/7","Round-Robin"],
    sections: [
      { id: 'load-balancers-01', num: 1, label: 'Core Principles', group: 'Phase 1: Beginner' }
    ],
    flowSteps: [
      {
    ...
    comparisonPoints: [],
    quiz: {
      question: 'Placeholder Quiz for Load Balancers & Reverse Proxies',
      options: ['A', 'B', 'C', 'D'],
      correctIndex: 0,
