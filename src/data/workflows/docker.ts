...
export const dockerWorkflow: WorkflowTopicData = {
    id: 'docker',
    title: 'Docker & Containerization',
    subtitle: 'Dockerfile, images, containers, Docker Compose',
    tagline: 'Deep dive into Docker & Containerization concepts and code architectures.',
    accentColor: '#6366f1', // Indigo
    category: 'DevOps',
    tags: ["Docker","Images","Containers","Compose"],
    sections: [
      { id: 'docker-01', num: 1, label: 'Core Principles', group: 'Phase 1: Beginner' }
    ],
    flowSteps: [
      {
    ...
    comparisonPoints: [],
    quiz: {
      question: 'Placeholder Quiz for Docker & Containerization',
      options: ['A', 'B', 'C', 'D'],
      correctIndex: 0,
