...
export const graphqlWorkflow: WorkflowTopicData = {
    id: 'graphql',
    title: 'GraphQL',
    subtitle: 'Schemas, queries, mutations, resolvers, field execution',
    tagline: 'Deep dive into GraphQL concepts and code architectures.',
    accentColor: '#6366f1', // Indigo
    category: 'APIs',
    tags: ["Schemas","Queries","Resolvers","Mutations"],
    sections: [
      { id: 'graphql-01', num: 1, label: 'Core Principles', group: 'Phase 1: Beginner' }
    ],
    flowSteps: [
      {
    ...
    comparisonPoints: [],
    quiz: {
      question: 'Placeholder Quiz for GraphQL',
      options: ['A', 'B', 'C', 'D'],
      correctIndex: 0,
