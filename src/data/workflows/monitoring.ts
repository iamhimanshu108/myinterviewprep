...
export const monitoringWorkflow: WorkflowTopicData = {
    id: 'monitoring',
    title: 'Monitoring & Observability',
    subtitle: 'Prometheus, Grafana, structured logging, tracing',
    tagline: 'Deep dive into Monitoring & Observability concepts and code architectures.',
    accentColor: '#6366f1', // Indigo
    category: 'DevOps',
    tags: ["Prometheus","Grafana","Tracing","Logging"],
    sections: [
      { id: 'monitoring-01', num: 1, label: 'Core Principles', group: 'Phase 1: Beginner' }
    ],
    flowSteps: [
      {
    ...
    comparisonPoints: [],
    quiz: {
      question: 'Placeholder Quiz for Monitoring & Observability',
      options: ['A', 'B', 'C', 'D'],
      correctIndex: 0,
