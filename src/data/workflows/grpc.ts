...
export const grpcWorkflow: WorkflowTopicData = {
    id: 'grpc',
    title: 'gRPC & Protocol Buffers',
    subtitle: 'Binary serialization, streaming RPCs, proto definitions',
    tagline: 'Deep dive into gRPC & Protocol Buffers concepts and code architectures.',
    accentColor: '#6366f1', // Indigo
    category: 'APIs',
    tags: ["Protobuf","RPC","Streaming"],
    sections: [
      { id: 'grpc-01', num: 1, label: 'Core Principles', group: 'Phase 1: Beginner' }
    ],
    flowSteps: [
      {
    ...
    comparisonPoints: [],
    quiz: {
      question: 'Placeholder Quiz for gRPC & Protocol Buffers',
      options: ['A', 'B', 'C', 'D'],
      correctIndex: 0,
