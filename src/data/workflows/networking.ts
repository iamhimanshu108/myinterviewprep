...
export const networkingWorkflow: WorkflowTopicData = {
    id: 'networking',
    title: 'Internet & Networking Protocols',
    subtitle: 'HTTP/HTTPS, IP, DNS, TCP/UDP fundamentals',
    tagline: 'Deep dive into Internet & Networking Protocols concepts and code architectures.',
    accentColor: '#6366f1', // Indigo
    category: 'Fundamentals',
    tags: ["HTTP/HTTPS","IP","DNS","TCP/UDP"],
    sections: [
      { id: 'networking-01', num: 1, label: 'Core Principles', group: 'Phase 1: Beginner' }
    ],
    flowSteps: [
      {
    ...
    comparisonPoints: [],
    quiz: {
      question: 'Placeholder Quiz for Internet & Networking Protocols',
      options: ['A', 'B', 'C', 'D'],
      correctIndex: 0,
