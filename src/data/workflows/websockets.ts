...
export const websocketsWorkflow: WorkflowTopicData = {
    id: 'websockets',
    title: 'WebSockets & WebRTC',
    subtitle: 'Real-time bi-directional messaging and peer connections',
    tagline: 'Deep dive into WebSockets & WebRTC concepts and code architectures.',
    accentColor: '#6366f1', // Indigo
    category: 'APIs',
    tags: ["Real-time","Bi-directional","WebRTC"],
    sections: [
      { id: 'websockets-01', num: 1, label: 'Core Principles', group: 'Phase 1: Beginner' }
    ],
    flowSteps: [
      {
    ...
    comparisonPoints: [],
    quiz: {
      question: 'Placeholder Quiz for WebSockets & WebRTC',
      options: ['A', 'B', 'C', 'D'],
      correctIndex: 0,
